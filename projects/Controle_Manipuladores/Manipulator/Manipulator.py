...
class Manipulator(BaseApp):
    """
    Classe principal da simulação Manipulator.
    ...
    def __init__(self):
        ...
        super().__init__(scene_file="manipulator.ttt", sim_name="Manipulator", sim_time=120)
